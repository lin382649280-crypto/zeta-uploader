...
__export(index_exports, {
  buildFileFingerprint: () => buildFileFingerprint,
  createLargeFileUploadManager: () => createLargeFileUploadManager,
  formatFileSize: () => formatFileSize,
  resolveOverallProgress: () => resolveOverallProgress,
  resolveTaskProgressPercent: () => resolveTaskProgressPercent,
  resolveTaskUploadedBytes: () => resolveTaskUploadedBytes
});
